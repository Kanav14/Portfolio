...
.black-background::before {
  ...
  width: 100%;
  height: 100%;
  background-image: radial-gradient(circle, rgba(0, 204, 255, 0.8) 3px, transparent 10px); /* Brighter and adjusted opacity */
  background-size: 30px 30px; /* Increased gaps between dots */
